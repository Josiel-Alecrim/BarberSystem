 ...
 */
public class Email {
    //E-MAIL QUE VAI ENVIAR (SEU E-MAIL)
    static final String REMETENTE_NOME = "coloque seu e-mail aqui";
    static final String REMETENTE_SENHA = "senha do seu e-mail";
    ...
    public void enviar (){
        SimpleEmail email = new SimpleEmail();
            ...
            email.setHostName("smtp.gmail.com");//smtp.gmail.com
            email.setSslSmtpPort("465");//465
